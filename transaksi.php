                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="POST">
                                                            ...
                                                            <div class="modal-body">
                                                                <input type="text" name="nama_produk" class="form-control" placeholder="Nama Produk" value="<?= $namaproduk; ?> - <?= $deskripsi; ?>">
                                                                <input type="number" name="qty" class="form-control mt-4" placeholder="Jumlah" min="1" value="<?= $qty; ?>" required>
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="submit" class="btn btn-primary" name="edittransaksi">Save changes</button>
                                                            </div>
                                            ...
                                            <div class="modal fade" id="delete<?= $idd; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">Yakin ingin menghapus barang ini?</h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        ...
                                                        <form method="POST">
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-danger" data-bs-dismiss="modal" aria-label="Close">close</button>
                                                                <button type="submit" class="btn btn-primary" name="hapuspesanan">Save changes</button>
                                                            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal" aria-label="Close">close</button>
                    <button type="submit" class="btn btn-primary" name="addproduk">Save changes</button>
                </div>
